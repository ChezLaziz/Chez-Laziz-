      ...
      <main className="pt-16 md:pt-20">
        <section className="mx-auto max-w-4xl px-5 py-24 md:px-10 md:py-32">
          <p data-reveal className="mb-5 text-[11px] font-medium uppercase tracking-[0.35em] text-accent">
            Le Journal Chez Laziz
          </p>
          <h1 data-reveal className="font-display text-4xl leading-tight md:text-6xl">
            Le makroudh tunisien, raconté
          </h1>
          <p data-reveal className="mt-6 max-w-xl text-[15px] font-light leading-relaxed text-ink/70">
            Histoire, tradition et savoir-faire autour du makroudh — pour mieux connaître ce que nous façonnons
            chaque jour à Kairouan.
          </p>
          ...
          <div className="mt-14 space-y-6">
            {ARTICLES.map((a) => (
              ...
              >
                <h2 className="font-display text-2xl leading-snug text-ink md:text-3xl">{a.title}</h2>
                <p className="mt-3 text-[15px] font-light leading-relaxed text-ink/65">{a.excerpt}</p>
