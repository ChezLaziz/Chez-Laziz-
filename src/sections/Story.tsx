            ...
            <div className="relative w-full lg:w-[92%]">
              ...
              <div className="mask-reveal relative aspect-[2/3] max-h-[760px] w-full bg-[#e9dccf]">
                <img
                  ...
                  width={774}
                  height={1018}
                  alt={isAr ? 'طبق ذهبي من مقروض القيروان المنقوش، قطعتان مقطوعتان تُظهران عجينة التمر' : 'Plateau doré de makroudh kairouanais estampés, deux pièces coupées révélant la pâte de dattes'}
              ...
              >
                <img
                  ...
                  width={640}
                  height={640}
                  alt={isAr ? 'لقطة قريبة لمقروض مغطى بحبوب السمسم' : 'Gros plan sur des makroudh enrobés de graines de sésame'}
